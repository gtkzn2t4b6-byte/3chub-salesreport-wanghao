...
# 奈拉→人民币换算 (2026-09-02 参考价: 1 NGN ≈ 0.0050 CNY, 1元≈200奈拉; 联网多源0.0049~0.0051, 可随时调整)
NGN_CNY_RATE = 0.0050
def fmt_rmb(ngn):
...
.mode-tab{border-color:#cbd5e1;color:#64748b}
.mode-tab.active{background:#e2e8f0;color:#0f172a;border-color:#94a3b8}
        ...
        <div style="margin-top:24px;padding-top:20px;border-top:1px solid var(--border)">
            ...
            <div style="display:flex;gap:8px;align-items:center;margin-bottom:12px;flex-wrap:wrap">
                ...
                <div style="position:relative;margin-left:4px">
                    ...
                    <div id="trend-combo-dropdown" style="display:none;position:absolute;top:100%;left:0;width:280px;background:var(--surface);border:1px solid var(--border);border-radius:6px;z-index:1000;margin-top:2px;box-shadow:0 8px 24px rgba(0,0,0,0.5)">
...
<div class="kpi-row">
    ...
    <div class="kpi-card">
        ...
        <div class="kpi-sub">毛利 {fmt_naira(M['total_profit'])} <span style="color:#94a3b8">{fmt_rmb(M['total_profit'])}</span> | 毛利率 {M['total_profit']/M['total_revenue']*100:.1f}%</div>
    </div>
    <div class="kpi-card">
        ...
        <div id="inv-store-model" class="inv-sub" style="display:none">
            ...
            <div style="margin-bottom:10px;display:flex;align-items:center;gap:8px;flex-wrap:wrap">
                ...
                <div style="position:relative">
                    ...
                    <div id="store-combo-dropdown" style="display:none;position:absolute;top:100%;left:0;width:280px;background:var(--surface);border:1px solid var(--border);border-radius:6px;z-index:1000;margin-top:2px;box-shadow:0 8px 24px rgba(0,0,0,0.5)">
                        <div style="padding:6px 8px;border-bottom:1px solid var(--border)">
...
// 导航条吸顶位置 = header 实际高度 (header 本身 sticky, 避免被盖住)
(function() {{
    var h = document.querySelector('.header');
    var n = document.getElementById('mod-nav');
    if (!h || !n) return;
    function fitModNav() {{ n.style.top = h.offsetHeight + 'px'; }}
    fitModNav();
