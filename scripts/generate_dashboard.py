...
<div class="header">
    ...
    <div style="display:flex;align-items:center;gap:12px;">
        <div class="page-tabs" id="page-tabs" style="display:none;gap:4px;margin-right:12px;">
            ...
            {'''<button class="page-tab" onclick="switchPage('kpi')" id="tab-kpi">🎯 年度任务</button>''' if K else ''}
        </div>
...
// 导航条吸顶位置 = header 实际高度 (header 本身 sticky; 切换模式后 page-tabs 显示会改变 header 高度, 用 ResizeObserver 跟踪)
(function() {{
